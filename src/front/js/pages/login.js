        ...
        <div className="content">
          {
             isShow && (
              <div className="input-field">
                <input type="text" value={user.name} placeholder="Name" autocomplete="nope" onChange={(e) => setUser({...user, name: e.target.value})}/>
              </div>
            )                      
          }
          <div className="input-field">
            <input type="email" value={user.email} placeholder="Email" autocomplete="nope" onChange={(e) => setUser({...user, email: e.target.value})} />
          </div>
          <div className="input-field">
            <input
              type="password"
